...
{
    /// <inheritdoc />
    public partial class IdentityYPedidos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoraLimitePedido = table.Column<TimeOnly>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CheckoutId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ...
                    DetalleEntrega = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pedidos_PuntosEntrega_PuntoEntregaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CobradoPorVendedorId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pedidos_PuntoEntregaId",
                table: "Pedidos",
                column: "PuntoEntregaId");
